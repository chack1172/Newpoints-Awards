...
function IconSelect($$elementID, $$parameters) {
    ...
    this.refresh = function($icons, $selected){
    ...
    _View.createUI = function($parameters){
        ...
        */
        ...
        componentIconImgElement.setAttribute('src', $parameters.arrowImagePath );
        ...
        _View.selectedIconImgElement.style.width = $parameters.selectedIconWidth + 'px';
        _View.selectedIconImgElement.style.height = $parameters.selectedIconHeight + 'px';
        selectedIconElement.style.minWidth = $parameters.selectedIconWidth + 'px';
        selectedIconElement.style.minHeight = $parameters.selectedIconHeight + 'px';
    ...
    _View.createIcon = function($iconFilePath, $iconValue, $index, $parameters){
        ...
        iconElement.style.minWidth = $parameters.iconsWidth + 'px';
        iconElement.style.minHeight = $parameters.iconsHeight + 'px';
